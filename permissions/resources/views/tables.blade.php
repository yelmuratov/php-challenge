<tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
    <td class="px-6 py-4" colspan="5">
        <a href="{{ route('users.store') }}"
            class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 float-end">
            Create User
        </a>
    </td>
</tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Toggle create user modal visibility
        document.querySelector('a[href="{{ route('users.store') }}"]').addEventListener('click', function(event) {
            event.preventDefault();
            createUserModal.classList.toggle('hidden');
        });

        // Close create user modal
        document.querySelectorAll('[data-modal-hide="create-user-modal"]').forEach(function(button) {
            button.addEventListener('click', function() {
